...
# get unique values then sort
print(np.sort(loan_data['annual_inc'].unique()))
print(np.sort(loan_data['delinq_2yrs'].unique()))
print(np.sort(loan_data['inq_last_6mths'].unique()))
print(np.sort(loan_data['open_acc'].unique()))
print(np.sort(loan_data['pub_rec'].unique()))
print(np.sort(loan_data['total_acc'].unique()))
print(np.sort(loan_data['acc_now_delinq'].unique()))
